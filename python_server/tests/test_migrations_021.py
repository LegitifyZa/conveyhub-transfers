...
class Migration021StaticTests(unittest.TestCase):
    @staticmethod
    def _load_migration() -> str:
        ...
        path = os.path.join(
            ...
            "lib",
            "migrations",
            "021_deedly_specialist_role_capacity_persistence.sql",
        )
...
class Migration021DbIntegrationTests(unittest.IsolatedAsyncioTestCase):
    @classmethod
    def setUpClass(cls):
