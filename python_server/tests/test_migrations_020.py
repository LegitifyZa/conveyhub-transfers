...
class Migration020StaticTests(unittest.TestCase):
    ...
    def _load_migration() -> str:
        ...
        path = os.path.join(
            ...
            "lib",
            "migrations",
            "020_deedly_taxonomy_approved_classifications.sql",
        )
...
class Migration020DbIntegrationTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_020_classifications_exist_and_are_selectable(self):
        from db import query
    ...
    async def test_020_is_idempotent(self):
        from db import query
        from tests.db_test_utils import with_test_transaction
    ...
    async def test_020_does_not_duplicate_existing_classifications(self):
        from db import query
        from tests.db_test_utils import with_test_transaction
    ...
    async def test_020_preserves_original_classifications(self):
        from db import query
        from tests.db_test_utils import with_test_transaction
    ...
    async def test_020_approved_count_is_18(self):
        from db import query
        from tests.db_test_utils import with_test_transaction
